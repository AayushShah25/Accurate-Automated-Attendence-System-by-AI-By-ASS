...
class Show:
    def __init__(self, top=None):
        ...
        self.IDd.configure(text='''IDd''')

        self.NAMEd = tk.Label(top)
        self.NAMEd.place(relx=0.383, rely=0.35, height=71, width=124)
        ...
        self.NAMEd.configure(text='''Named''')

        self.AGEd = tk.Label(top)
        self.AGEd.place(relx=0.167, rely=0.45, height=71, width=174)
        ...
        self.AGEd.configure(text='''Aged''')

        self.GENDERd = tk.Label(top)
        self.GENDERd.place(relx=0.2, rely=0.55, height=71, width=124)
        ...
        self.GENDERd.configure(text='''Genderd''')

        self.POSTd = tk.Label(top)
        self.POSTd.place(relx=0.198, rely=0.643, height=71, width=124)
        ...
        self.POSTd.configure(text='''Postd''')

        self.CONTACTd = tk.Label(top)
        self.CONTACTd.place(relx=0.217, rely=0.763, height=71, width=124)
        ...
        self.CONTACTd.configure(text='''Contactd''')

        self.ADDRESSd = tk.Label(top)
        self.ADDRESSd.place(relx=0.233, rely=0.838, height=81, width=104)
        ...
        self.ADDRESSd.configure(text='''Addressd''')
